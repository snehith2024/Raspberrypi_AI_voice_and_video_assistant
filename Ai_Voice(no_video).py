...
def chatfun(request, text_queue, llm_done, stop_event):
    ...
    #response = llm.invoke([HumanMessage(content="Hello, Tarss!")])
    ...
    while True:     
        ...
        with mic as source:            
            ...
            try: 
                ...
                if sleeping == True:
                    # User can start the conversation with the wake word "Tarss"
                    # This word can be chagned below. 
                    if "tarss" in text.lower():
                        request = text.lower().split("tarss")[1]
